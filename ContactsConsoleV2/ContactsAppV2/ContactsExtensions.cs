...
using ContactsConsoleV2.Models;
...
namespace ContactsConsoleV2
{
    public static partial class ContactsExtensions
    {
        ...
        /// Reference to the ContactsConsoleV2.IContacts.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<ContactsConsoleV2.Models.Contact>> result = await operations.GetWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
    }
}
